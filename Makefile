...
#
SYSCONFDIR=/opt/win32/etc
BINDIR=/opt/win32/bin
MANDIR=/opt/win32/man
...
#
CC=i386-mingw32-gcc
OBJS=utils.o ntlm.o spnego.o xcrypt.o config.o socket.o acl.o auth.o http.o proxy.o 
CFLAGS=$(FLAGS) -std=c99 -Wall -pedantic -O3 -D__BSD_VISIBLE -D_ALL_SOURCE -D_XOPEN_SOURCE=600 -D_POSIX_C_SOURCE=200112 -D_ISOC99_SOURCE -D_REENTRANT -DVERSION=\"`cat VERSION`\" -I/opt/win32/include -L/opt/win32/lib
LDFLAGS=-lpthread
NAME=cntlm
VER=`cat VERSION`
DIR=`pwd`
